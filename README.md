...
<div style="font-size: 16px">
    <p>
        Working on the portfolio while learning in ZTM, so the tech stack might change depending on how comfortable I am to create the portfolio.
    </p>
    <ul>Current Stack that I'm using:
        <li>Next.js</li>
        <li>Tailwind CSS</li>
    </ul>
    <p>Might change to Vue.js</p>
</div>